...
export default function About(){
  ...
  <p className = "text-light">
    ...
    Through the expressed need for a dedicated sight seen through the many reddit threds and facebook groups, [Insert Webisite Name Here] was born. <br/>
  </p> 
  <br></br>
  <p className = "text-light">
    <b><u>Isaac Ingalls</u>: Project Manager</b><br/>
    Isaac is a fourth year Business Computer Information Systems Major interested in data and business analytics. Stocks and analyzing future investments are passion projects
    that he had before this class, so he took the lead roll in this project. He uses the management skills and large scale ideas learned through the Monfort College of Business
    to guide the more technical members of the team to create the website we planned and invisioned. Outside of school he participates in weightlighting and a competitive bowling 
    league. <br/>
    <a href = "https://www.linkedin.com/in/isaac-ingalls-5609a017b/" target="_blank">LinkedIn</a>  
  </p>
  <br></br>
  <p className = "text-light" align = "right">
  <b><u>Junwen Huang</u>: Frontend Developer</b><br/>
    ...
    <a href = "https://www.linkedin.com/in/junwen-huang-658aaa202/" target="_blank">LinkedIn</a> 
  </p>
  <br></br>
  <p className = "text-light" >
    ...
    using management skills and large scale ideas to guide the more technical members of the team to create the website we planned and invisioned. Outside of school he participates 
    in weightlighting and a competitive bowling league. <br/>
    <a href = "https://www.linkedin.com/in/erik-halenkamp-4b49451a6/" target="_blank">LinkedIn</a>  
  </p>
  <br></br>
  <p className = "text-light" align = "right">
  <b><u>Yusuf Kortobi</u>: Frontend Developer</b><br/>
    Isaac is a third year Business Computer Information Systems Major interested in data analytics and large scale backend calculations. He took the lead roll in this project 
    using management skills and large scale ideas to guide the more technical members of the team to create the website we planned and invisioned. Outside of school he participates 
    in weightlighting and a competitive bowling league. <br/><a href = "https://www.linkedin.com/in/yusuf-kortobi-aa496b19b/" target="_blank"> LinkedIn</a>  
  </p>
  <br></br>
  <p className = "text-light" >
